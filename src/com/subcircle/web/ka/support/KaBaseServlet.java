...
@WebServlet("*.kahtml")
public class KaBaseServlet extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{
			//包名
			String packageName="com.subcircle.web.ka.impl.";
			//获取请求的资源路径  /项目名/资源名.html
			String uri=request.getRequestURI();
			//提取资源名
			String baseName=uri.substring(uri.lastIndexOf("/")+1).replace("ka.html", "");
			//转换成目标Controller名
