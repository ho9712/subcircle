...
<div class="infobox">
    ...
    <c:when test="${sessionScope.user.kkd101!=null }">
        ...
        <span class="tip_i">
                <p><span class="tip">修改：</span>               
                	...
                	<a href="kc02Edit.kchtml?kkc101=${param.kkc101 }" class="l">
                	</c:when>
    ...
    <div id="subject_summary" class="subject_summary" property="v:summary"><pre>${ins.kkc217}</pre></div>
...
<input type="hidden" name="kkd101" value="${sessionScope.user.kkd101 }">
<input type="hidden" name="kkc101" value="${param.kkc101 }">
<input type="hidden" name="kka103" value="1">
