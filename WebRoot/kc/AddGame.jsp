...
<form action="kc04AddGame.kchtml" method="post">
<table class="olt"><tr><td></td><td></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">条目名</p></td><td>
<input type = "text" name="kkc409" class="inputtext" value="" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">中文名</p></td><td>
<input type = "text" name="kkc402" class="inputtext" value="" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">缩略信息</p></td><td>
<input type = "text" name="kkc405" class="inputtext" value="" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">信息</p></td><td>
<textarea name="kkc410" id="content" class="reply" cols="45" rows="7"  ></textarea>
<tr><td nowrap="nowrap" width="15%"><p class="tip">简介</p></td><td>
<textarea name="kkc411" id="content" class="reply" cols="45" rows="7"  ></textarea>

<input type="hidden" name="kkc101" value = ""  />
<input type="hidden" id="kkc404" name="kkc404" value = "">
