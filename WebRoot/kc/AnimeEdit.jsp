...
<form action="kc02Edited.kchtml" method="post">
<table class="olt"><tr><td></td><td></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">条目名</p></td><td>
<input type = "text" name="" class="inputtext" value="${ins.kkc202 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">中文名</p></td><td>
<input type = "text" name="kkc202" class="inputtext" value="${ins.kkc202 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">话数</p></td><td>
<input type = "text" name="kkc209" class="inputtext" value="${ins.kkc209 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">原作</p></td><td>
<input type = "text" name="kkc210" class="inputtext" value="${ins.kkc210 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">分镜</p></td><td>
<input type = "text" name="kkc211" class="inputtext" value="${ins.kkc211 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">演出</p></td><td>
<input type = "text" name="kkc212" class="inputtext" value="${ins.kkc212 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">音乐</p></td><td>
<input type = "text" name="kkc213" class="inputtext" value="${ins.kkc213 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">原画</p></td><td>
<input type = "text" name="kkc214" class="inputtext" value="${ins.kkc214 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">官方网站</p></td><td>
<input type = "text" name="kkc215" class="inputtext" value="${ins.kkc215 }" /></td></tr>
<tr><td nowrap="nowrap" width="15%"><p class="tip">电视台</p></td><td>
<input type = "text" name="kkc216" class="inputtext" value="${ins.kkc216 }" /></td></tr>

<tr><td nowrap="nowrap" width="15%"><p class="tip">简介</p></td><td>
<textarea name="kkc217" id="content" class="reply" cols="45" rows="7"  >${ins.kkc217 }</textarea>
