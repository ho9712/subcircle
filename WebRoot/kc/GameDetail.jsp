...
<h1 class="nameSingle">
   <a href="${ins.kkc403}" title="${ins.kkc402}" property="v:itemreviewed"></a>
   ${ins.kkc409}
                    </h1>
...
<div class="infobox">
                                <div align="center">
            <a href="${ins.kkc404}" title="${ins.kkc402}" alt="" class="thickbox cover"><img src="${ins.kkc404}" class="cover" /></a>
            </div>
            <ul id="infobox">
                                        <li><span class="tip"></span><pre>${ins.kkc410}</pre></li>
            </ul>
    ...
    <c:when test="${sessionScope.user.kkd101!=null }">
        ...
        <span class="tip_i">
                <p><span class="tip">修改：</span>               
                	...
                	<a href="kc04Edit.kchtml?kkc101=${param.kkc101 }" class="l">
                	</c:when>
    ...
    <div id="subject_summary" class="subject_summary" property="v:summary"><pre>${ins.kkc411}</pre></div>
...
评分人数
 -->
<span class="number" property="v:average">${ins.kkc406}</span>
<span property="v:best" content="10.0"></span>
<span class="description"></span><div><small class="grey">SubCircle Game Ranked:</small><small class="alarm">#${ins.kkc408}</small></div>
</div>
</div>
<div class="clear"></div>
