...
<div id="headerProfile" class="clearit">
	...
	<div class="navSubTabsWrapper">
		<ul class="navSubTabs">
			<li><a href="<%=path%>/kc06OtherAnimeColl.kdhtml?kkd101=${param.kkd101}" class="focus"><span>动画</span></a></li>
...
<div class="columns clearit" xmlns:v="http://rdf.data-vocabulary.org/#">
	<!-- 主页主体A栏 -->
		...
		<c:when test="${empty animeColls}">
			<div class="section">
	            <br><h2 class="title">Ta还没有收藏过动画...</h2>
	        	<div>
		...
		<div id="columnSubjectBrowserB" class="column">
			<div id="columnSubjectInBrowserB" class="clearit">
				<div class="SidePanel png_bg">
					<h2>/ 根据条件检索 </h2>
					<form id="myform" name="set" method="post" action="<%=path%>/kc06OtherAnimeColl.kdhtml?kkd101=${param.kkd101}">
						<span class="text">
...
<c:choose>
	<c:when test="${empty hint }">
		<strong>『Ta的动画收藏』</strong><br />
		这里显示了Ta所收藏的所有动画作品。 <br />
	</c:when>
	<c:otherwise>
