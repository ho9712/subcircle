...
<script type="text/javascript">
	function onClickSort(vorder)
	{
		...
		vform.action="<%=path%>/kc06AnimeColl.kdhtml?order="+vorder;
		vform.submit();
	}
	...
	function delColl(kkc601,kkc701)
	{
		...
		if(confirm(msg))
		{
			window.location.href="<%=path%>/kc06DelAnimeColl.kdhtml?kkc601="+kkc601+"&kkc701="+kkc701;		
			alert("取消收藏成功！");
		}
	}
</script>
...
<div class="columns clearit" xmlns:v="http://rdf.data-vocabulary.org/#">
	<!-- 主页主体A栏 -->
		...
		<div id="panel" style="display:none;"><div class="collectBox clearit">
		    <form id="collectBoxForm" name="collectBoxForm" method="post" action="kc06ModifyAnimeComment.kdhtml">
